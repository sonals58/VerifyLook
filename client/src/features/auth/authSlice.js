...
// Use Axios consistently for all async actions

// Instead of using fetch in registerUser async thunk:
...
// Similarly, update logoutUser, loginUser, and setScreenshotFromURL thunks using fetch.
