    ...
    return(
        <div className="col-12 my-box mb-4">
            <div className="heading">
                <h2 style={{ fontWeight: 'bold', color: '#87A922', fontFamily: 'Arial, sans-serif',fontSize: '24px' }}>Faces Recognised</h2>
            </div>
            <div className="row info mb-4">
                <div className="col-sm-12">
                    <p>When comparing two faces, their similarity is indicated by the Euclidean distance, where smaller distances suggest greater similarity. If the Euclidean distance falls within the range of 0.1 to 0.65, it indicates that the faces are more likely to be similar. Your presence here signifies that you have been authenticated.</p>
                    <p>Subsequently, the numerical features of the detected faces are presented in the graph below. The degree of similarity between the faces is reflected in the degree of overlap between the two lines on the graph.</p>
                </div>
            </div>
            <div className="row">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {
                                            user.loginPic && photoB.src && photoB.faces.length === 1 && photoB.faces[0].descriptor && photoB.faces[0].descriptor !== user.loginDescriptor ? 
                                            <div className="alert alert-danger">Faces Don't Match</div> : null
                                        }
                                    </td>
                                </tr>
                            </tbody>
